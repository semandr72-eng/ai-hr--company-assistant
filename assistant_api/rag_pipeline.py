...
if __name__ == "__main__":
    ...
    try:
        ...
        # Тестовые запросы
        test_queries = [
            "Сколько длится испытательный срок для гендиректора?",
            "В какие даты выплачивают зарплату за первую и вторую половину месяца?",
            "Какое время начала и окончания рабочего дня, а также обеденный перерыв?"
        ]
