...
EVALUATION_QUESTIONS = [
    "Когда работник должен быть ознакомлен с Правилами внутреннего трудового распорядка и в какой форме?",
    "За какой срок работник обязан предупредить об увольнении по собственному желанию и как можно отозвать заявление?",
    "Каким категориям работников устанавливается ненормированный рабочий день и сколько дней дополнительного отпуска им полагается?",
    "В каких случаях работодатель обязан предоставить отпуск без сохранения зарплаты?",
    "В каком размере работник несёт материальную ответственность за причинённый ущерб по общему правилу и когда возможна полная ответственность?"
]
